...
public class FileDownloadUtil {
    ...
    @RequestMapping("/game")
    public void downloadGame(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (file.exists()) {
            ...
            //Here we have mentioned it to show as attachment
            response.setHeader("Content-Disposition", String.format("attachment; filename=\"" + "kingsPoker.apk" + "\""));
